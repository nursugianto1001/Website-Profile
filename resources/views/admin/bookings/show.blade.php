    ...
    <div class="mb-8 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                @if(in_array($booking->payment_status, ['pending', 'settlement']))
                <form action="{{ route('admin.bookings.cancel', $booking->id) }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" 
                            class="inline-flex items-center px-3 py-2 bg-red-100 border border-red-300 rounded-lg text-sm font-medium text-red-700 hover:bg-red-200 transition-colors"
