...
<div class="bg-gradient-to-br from-white to-gray-50 p-8 rounded-lg shadow-lg ml-24 border border-gray-100">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Create a new {{ request('type') == 'documentation' ? 'documentation photo' : 'poster' }} in your gallery</p>
        </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="mb-6 pb-4 border-b border-gray-100">
            <div class="flex items-center text-{{ request('type') == 'documentation' ? 'purple' : 'green' }}-600">
                ...
                <span class="font-medium">Enter {{ request('type') == 'documentation' ? 'Photo' : 'Poster' }} Details</span>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="type" value="poster" {{ request('type') == 'poster' ? 'checked' : '' }}
                            ...
                            <label class="inline-flex items-center">
                                <input type="radio" name="type" value="documentation" {{ request('type') == 'documentation' ? 'checked' : '' }}
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 rounded-lg bg-white">
                            <div class="space-y-3 text-center">
                                ...
                                <div id="image-preview" class="hidden mt-2">
                                    <img id="preview-img" src="#" alt="Preview" class="mx-auto max-h-40 rounded-md">
                                </div>
                                <div class="flex text-sm text-gray-600">
                                    <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                        ...
                                        <input type="file" name="image" id="image" required accept="image/*" class="sr-only">
                                    </label>
