...
<div class="bg-gradient-to-br from-white to-gray-50 p-8 rounded-lg shadow-lg ml-24 border border-gray-100">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Update details for "{{ $gallery->title }}"</p>
        </div>
        <a href="{{ route('admin.gallery.index') }}" class="px-4 py-2.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition shadow-sm flex items-center">
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="mb-6 pb-4 border-b border-gray-100">
            <div class="flex items-center text-amber-600">
                ...
                <span class="font-medium">Edit {{ $gallery->type == 'documentation' ? 'Photo' : 'Poster' }} Details</span>
            </div>
        </div>
        ...
        <form action="{{ route('admin.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data" class="max-w-3xl">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="type" value="poster" {{ $gallery->type == 'poster' ? 'checked' : '' }}
                            ...
                            <label class="inline-flex items-center">
                                <input type="radio" name="type" value="documentation" {{ $gallery->type == 'documentation' ? 'checked' : '' }}
                                ...
                                <span class="ml-2 text-gray-700">Documentation Photo</span>
                            </label>
                        </div>
                        @error('type')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <p class="text-xs text-gray-500 mt-2 pl-12">Featured items will be displayed prominently on the website homepage</p>
                        </div>
                        <div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 h-full">
                        ...
                        <div class="mb-4 bg-white p-2 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <p class="text-xs text-gray-500 mt-2 text-center truncate">{{ $gallery->image_path }}</p>
                        </div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 rounded-lg bg-white">
                            <div class="space-y-3 text-center">
                                ...
                                <div id="image-preview" class="hidden mt-2">
                                    <img id="preview-img" src="#" alt="New Image Preview" class="mx-auto max-h-32 rounded-md">
                                </div>
            ...
            <div class="flex justify-between mt-8 pt-5 border-t border-gray-100">
                <form action="{{ route('admin.gallery.destroy', $gallery) }}" method="POST" 
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-4 py-2 bg-red-50 text-red-600 font-medium rounded-lg hover:bg-red-100 transition border border-red-200 flex items-center">
                        <i class="bi bi-trash mr-2"></i>
                        Delete {{ $gallery->type == 'documentation' ? 'Photo' : 'Poster' }}
                    </button>
                </form>
                
                <div class="flex space-x-3">
                    <a href="{{ route('admin.gallery.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition border border-gray-200">
                        Cancel
                    </a>
                    <button type="submit" class="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 transition shadow-sm flex items-center">
