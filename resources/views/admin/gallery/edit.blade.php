            ...
            <form action="{{ route('admin.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-6">
                    ...
                    <select name="type" id="type" required
                        ...
                        <option value="documentation" {{ $gallery->type == 'documentation' ? 'selected' : '' }}>
                            Documentation
                            Photo</option>
                    </select>
                    @error('type')
                ...
                <div class="mb-6">
                    ...
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Upload New Image
                        (Optional)</label>
                    <div class="flex items-center">
                        <input type="file" name="image" id="image" accept="image/*"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <p class="text-sm text-gray-500 mt-1">Leave empty to keep current image. Accepted formats: JPEG, PNG,
                        JPG,
                        GIF. Max size: 2MB.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label for="display_order" class="block text-sm font-medium text-gray-700 mb-2">Display
                            Order</label>
