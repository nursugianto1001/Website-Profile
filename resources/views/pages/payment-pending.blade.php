...
<body class="bg-green-500/90">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-3xl font-bold mb-6 text-green-200">Detail Pembayaran</h1>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="border-t border-green-100 pt-4 mb-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                <span class="font-bold text-green-600">{{ $booking['field_name'] }}</span>:
            ...
            <div class="text-center mt-6">
                <a href="/fields/book" class="inline-flex items-center px-5 py-3 bg-white/70 backdrop-blur-sm hover:bg-white/90 text-green-600 border border-green-600/20 hover:border-green-600/40 font-medium rounded-lg shadow transition-all duration-300 mr-4">
                ...
                <button id="pay-button" class="inline-flex items-center px-5 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div id="loading-indicator" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-green-700 font-medium">Memproses pembayaran...</p>
