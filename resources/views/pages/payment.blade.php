...
<body class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-500 rounded-lg shadow-xl overflow-hidden mb-6 border border-emerald-400">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex justify-between border-b border-emerald-600 pb-3">
                        <span class="font-medium text-emerald-800">Waktu:</span>
                        <span class="text-emerald-700">{{ \Carbon\Carbon::parse($bookings->first()->booking_date)->format('d M Y') }}</span>
                    </div>
                    ...
                    <div class="border-t border-emerald-600 pt-4 mb-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                <span class="font-bold text-emerald-800">{{ $b->field->name }}</span>:
                    ...
                    @endphp
                    <div class="flex justify-between text-base font-medium mt-4 pt-2 border-t border-emerald-600">
                    ...
                    <div class="flex justify-between text-lg font-bold mt-2 pt-2 border-t border-emerald-600">
                        <span class="text-emerald-800">Total Biaya:</span>
                        <span id="total-amount" class="text-emerald-800">Rp {{ number_format($totalPrice, 0, ',', '.') }}</span>
                    </div>
                    ...
                    <div class="mt-4 p-3 bg-gradient-to-br from-emerald-600 to-emerald-700 border-l-4 border-emerald-800 text-white rounded">
                        ...
                        <span class="text-sm text-emerald-200">Setiap transaksi dikenakan biaya admin Rp5.000.</span>
                    </div>
                </div>
            </div>

            <div class="text-center mt-6">
                <a href="/" class="inline-flex items-center px-5 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white font-medium rounded-lg shadow-lg transition-all duration-300">
            ...
            <div id="loading-indicator" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-500 p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-emerald-800 font-medium">Mempersiapkan pembayaran...</p>
