...
<div class="relative z-30 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-duration="1000">
                    <h2 class="text-3xl font-bold text-emerald-600 mb-6">Informasi Kontak</h2>
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-emerald-600 mt-1 mr-3"
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">saranasehatborneo2@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-slate-700">No. HP</h3>
                                <p class="text-slate-600"> +62 822-1000-2256</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-slate-700">Kantor Kami</h3>
                                <p class="text-slate-600"> Jalan Veteran, Jalan Karvin, Pontianak, Kalimantan Barat</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="py-20 bg-gradient-to-tl from-teal-50 via-emerald-100 to-green-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-emerald-700">Hubungi Kami</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gradient-to-br from-emerald-100 via-emerald-200 to-green-100 shadow-lg rounded-xl overflow-hidden transition transform hover:scale-105 hover:shadow-xl p-6 border border-emerald-100"
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-emerald-700">Jam Kerja</h3>
                        <ul class="space-y-4 text-slate-600 text-center">
                ...
                <div class="bg-gradient-to-br from-green-100 via-green-200 to-emerald-100 shadow-lg rounded-xl overflow-hidden transition transform hover:scale-105 hover:shadow-xl p-6 border border-green-100"
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-emerald-700">Ikuti Kami</h3>
                        <p class="text-slate-600 mb-4 text-center leading-relaxed">
                        ...
                        <div class="flex space-x-6 justify-center">
                            <a href="https://www.instagram.com/karvin_badminton/"
                                class="text-slate-600 hover:text-emerald-600 transition-colors duration-300">
                            ...
                            <a href="https://www.tiktok.com/@karvinbadminton?_t=ZS-8xlSGLPLg4V&_r=1 " class="text-slate-600 hover:text-emerald-600 transition-colors duration-300">
                                <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="py-20 bg-gradient-to-b from-green-50 via-emerald-50 to-teal-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-emerald-700">Temui Kami</h2>
                <p class="text-slate-700 mb-4 max-w-3xl mx-auto mt-4 leading-relaxed">
                    Datanglah ke tempat kami lokasinya mudah dijangkau!
                </p>
            </div>
            <div class="bg-gradient-to-br from-emerald-100 via-white to-green-50 rounded-lg overflow-hidden shadow-xl"
