                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden" data-aos="fade-left" data-aos-duration="800">
                    <div class="p-8">
                        ...
                        <div class="flex space-x-6">
                            ...
                            <a href="https://www.instagram.com/karvin_badminton/" class="text-gray-600 hover:text-[#A66E38] transition-colors duration-300">
                                <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd"
            ...
            <div class="rounded-lg overflow-hidden shadow-xl" data-aos="zoom-in" data-aos-duration="800">
                <div class="relative bg-gray-100 h-96">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
                        <a href="https://maps.app.goo.gl/XryjjSfbFV3FjJJAA" target="_blank" class="text-blue-600 bg-white hover:bg-blue-50 px-6 py-4 rounded-lg shadow-lg font-medium flex items-center transition duration-300">
