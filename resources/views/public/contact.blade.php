...
<div class="relative z-30 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-duration="1000">
                    <h2 class="text-3xl font-bold text-green-300 mb-6">Informasi Kontak</h2>
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-300 mt-1 mr-3"
                            ...
                            <div>
                                ...
                                <p class="text-green-100">saranaseharborneo2@gmail.com</p>
                            </div>
                        </div>
    ...
    <div class="py-20 bg-green-700/90">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-green-300">Hubungi Kami</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gradient-to-br from-white via-green-50 to-green-100 shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105"
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-green-700">Jam Kerja</h3>
                ...
                <div class="bg-gradient-to-br from-green-50 via-white to-green-100 shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105"
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-green-700">Ikuti Kami</h3>
                        ...
                        <div class="flex space-x-6 justify-center">
                            ...
                            <a href="https://www.tiktok.com/@karvinbadminton?_t=ZS-8xlSGLPLg4V&_r=1 " class="text-gray-600 hover:text-green-600 transition-colors duration-300">
                                <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="py-20 bg-gradient-to-b from-green-600/80 to-green-700/70">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-green-300">Temui Kami</h2>
