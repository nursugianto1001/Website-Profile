...
<div class="relative z-30 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-duration="1000">
                    <h2 class="text-3xl font-bold text-emerald-200 mb-6">Informasi Kontak</h2>
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-emerald-300 mt-1 mr-3"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <div>
                                <h3 class="font-semibold text-emerald-200">Email</h3>
                                <p class="text-emerald-100">saranasehatborneo2@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-emerald-200">No. HP</h3>
                                <p class="text-emerald-100"> +62 822-1000-2256</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-emerald-200">Kantor Kami</h3>
                                <p class="text-emerald-100"> Jalan Veteran, Jalan Karvin, Pontianak, Kalimantan Barat</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="py-20 bg-gradient-to-tl from-emerald-700 via-emerald-800 to-emerald-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-emerald-200">Hubungi Kami</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-500 shadow-xl rounded-xl overflow-hidden transition transform hover:scale-105 hover:shadow-2xl p-6 border border-emerald-400"
                    ...
                    <div class="p-2">
                        <div
                            ...
                            <i class="fas fa-clock text-2xl text-emerald-700"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-6 text-center text-emerald-800">Jam Kerja</h3>
                        <ul class="space-y-4 text-emerald-700 text-center">
                ...
                <div class="bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 shadow-xl rounded-xl overflow-hidden transition transform hover:scale-105 hover:shadow-2xl p-6 border border-emerald-500"
                    data-aos="fade-left" data-aos-duration="800">
                    <div class="p-2">
                        <div
                            class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg bg-gradient-to-br from-white to-gray-100">
                            <i class="fas fa-share-alt text-2xl text-emerald-700"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-6 text-center text-emerald-800">Ikuti Kami</h3>
                        <p class="text-emerald-700 mb-4 text-center leading-relaxed">
                        ...
                        <div class="flex space-x-6 justify-center">
                            <a href="https://www.instagram.com/karvin_badminton/"
                                class="text-emerald-700 hover:text-emerald-200 transition-colors duration-300">
                            ...
                            <a href="https://www.tiktok.com/@karvinbadminton?_t=ZS-8xlSGLPLg4V&_r=1 " class="text-emerald-700 hover:text-emerald-200 transition-colors duration-300">
                                <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="py-20 bg-gradient-to-b from-emerald-800 via-emerald-700 to-emerald-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-emerald-200">Temui Kami</h2>
                <p class="text-emerald-100 mb-4 max-w-3xl mx-auto mt-4 leading-relaxed">
                    Datanglah ke tempat kami lokasinya mudah dijangkau!
                </p>
            </div>
            <div class="bg-gradient-to-br from-emerald-300 via-white to-emerald-200 rounded-lg overflow-hidden shadow-xl"
                ...
                <div class="relative bg-gray-100 h-96">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
                        <a href="https://maps.app.goo.gl/XryjjSfbFV3FjJJAA" target="_blank"
                            class="text-emerald-700 bg-white hover:bg-emerald-50 px-6 py-4 rounded-lg shadow-lg font-medium flex items-center transition duration-300">
