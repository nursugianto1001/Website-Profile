...
<div class="relative z-30 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-duration="1000">
                    <h2 class="text-3xl font-bold text-green-400 mb-6">Informasi Kontak</h2>
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-400 mt-1 mr-3"
                            ...
                            <div>
                                ...
                                <p class="text-gray-100">saranasehatborneo2@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-100"> +62 822-1000-2256</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-100"> Jalan Veteran, Jalan Karvin, Pontianak, Kalimantan Barat</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="py-20 bg-green-800 bg-opacity-95">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-green-400">Hubungi Kami</h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gradient-to-br from-green-700 via-green-600 to-green-700 shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105"
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-green-400">Jam Kerja</h3>
                        <ul class="space-y-4 text-gray-100 text-center">
                ...
                <div class="bg-gradient-to-br from-green-600 via-green-700 to-green-600 shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105"
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold mb-6 text-center text-green-400">Ikuti Kami</h3>
                        <p class="text-gray-100 mb-4 text-center">
                        ...
                        <div class="flex space-x-6 justify-center">
                            <a href="https://www.instagram.com/karvin_badminton/"
                                class="text-gray-100 hover:text-green-400 transition-colors duration-300">
                            ...
                            <a href="https://www.tiktok.com/@karvinbadminton?_t=ZS-8xlSGLPLg4V&_r=1 " class="text-gray-100 hover:text-green-400 transition-colors duration-300">
                                <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="py-20 bg-gradient-to-b from-green-900 to-green-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl font-bold text-green-400">Temui Kami</h2>
                <p class="text-gray-100 mb-4 max-w-3xl mx-auto mt-4">
                ...
                <div class="relative bg-gray-100 h-96">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
                        <a href="https://maps.app.goo.gl/XryjjSfbFV3FjJJAA" target="_blank"
                            class="text-green-700 bg-white hover:bg-green-50 px-6 py-4 rounded-lg shadow-lg font-medium flex items-center transition duration-300">
