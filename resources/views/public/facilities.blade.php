...
<div class="relative z-30 bg-white">
    <!-- Facilities Overview Section - HIJAU -->
    <div class="py-12 md:py-20 bg-gradient-to-br from-starbucks-green via-starbucks-dark-green to-forest-green">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 md:mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-2xl md:text-3xl font-bold text-starbucks-cream mb-4">Fasilitas-Fasilitas Kami</h2>
                <p class="text-starbucks-beige mb-12 md:mb-24 max-w-3xl mx-auto text-sm md:text-base leading-relaxed">
                ...
                <div class="hidden md:grid md:grid-cols-2 gap-12">
                    ...
                    <div class="bg-gradient-to-br from-starbucks-light-green via-sage-green to-mint-green shadow-xl rounded-xl overflow-hidden flex flex-row transition transform hover:scale-105 hover:shadow-2xl border border-starbucks-light-green"
                        data-aos="{{ $index % 2 == 0 ? 'fade-right' : 'fade-left' }}" data-aos-duration="800"
                        data-aos-delay="{{ $index * 100 }}">
                        <div class="max-w-[250px] max-h-[250px] flex justify-center items-center bg-gradient-to-br from-white to-starbucks-cream">
                            <img src="{{ asset('storage/' . $facility->image_path) }}" alt="{{ $facility->name }}"
                                class="w-full h-[250px] object-cover aspect-square">
                        </div>
                        <div class="p-6 w-3/5">
                            <h3 class="text-2xl font-bold mb-4 text-starbucks-dark-green">
                                {{ $facility->name }}
                            </h3>
                ...
                <div class="md:hidden space-y-6">
                    @foreach ($facilities as $index => $facility)
                    <div class="bg-gradient-to-br from-starbucks-light-green via-sage-green to-mint-green shadow-xl rounded-xl overflow-hidden mx-2 border border-starbucks-light-green"
                        data-aos="fade-up" data-aos-duration="600" data-aos-delay="{{ $index * 100 }}">

                        <!-- Image Section -->
                        <div class="bg-gradient-to-br from-white to-starbucks-cream flex justify-center items-center">
                            <img src="{{ asset('storage/' . $facility->image_path) }}" alt="{{ $facility->name }}"
                        ...
                        <!-- Content Section -->
                        <div class="p-4">
                            <h3 class="text-xl font-bold mb-3 text-starbucks-dark-green text-center">
                                {{ $facility->name }}
                            </h3>
                            <p class="text-forest-green text-sm leading-relaxed text-justify">
                                {{ $facility->description }}
                            </p>
                        </div>
                    </div>
