...
@endif
<!-- Section Lapangan yang Sudah Di-booking -->
<div class="py-16 bg-gradient-to-b from-amber-50/90 to-[#f8e8d4]/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
            <h2 class="text-3xl font-bold text-[#A66E38]">Jadwal Lapangan Terbooking</h2>
            <p class="text-gray-700 mt-4">
                Lihat jadwal lapangan yang sudah dibooking untuk membantu Anda memilih waktu yang tepat
            </p>
        </div>

        @if($bookedFields->count() > 0)
        <!-- Desktop Grid View -->
        <div class="hidden md:grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6" data-aos="fade-up" data-aos-duration="800">
            @foreach($bookedFields as $booking)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-amber-100 hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-[#A66E38] to-[#8B5A2B] text-white p-4">
                    <h3 class="text-lg font-semibold">{{ $booking->field->name ?? 'Lapangan' }}</h3>
                    <div class="flex items-center mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        <span class="text-sm">{{ $booking->customer_name ?? 'Customer' }}</span>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="space-y-3">
                        <div class="flex items-center text-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-[#A66E38]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Mobile Swiper View -->
        <div class="md:hidden" data-aos="fade-up" data-aos-duration="800">
            <div class="swiper-container booked-fields-swiper">
                <div class="swiper-wrapper">
                    @foreach($bookedFields as $booking)
                    <div class="swiper-slide">
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-amber-100 h-[280px]">
                            <div class="bg-gradient-to-r from-[#A66E38] to-[#8B5A2B] text-white p-4">
                                <h3 class="text-lg font-semibold">{{ $booking->field->name ?? 'Lapangan' }}</h3>
                                <div class="flex items-center mt-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="p-4 flex-grow">
                                <div class="space-y-3">
                                    <div class="flex items-center text-gray-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-[#A66E38]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
        ...
        <div class="text-center mt-8">
            <a href="{{ route('booking.form') }}"
                ...
                style="background-color: #A66E38;"
                onmouseover="this.style.backgroundColor='#8B5A2B';"
                onmouseout="this.style.backgroundColor='#A66E38';">
                Pesan Lapangan Sekarang
            </a>
        </div>
        @else
        <!-- Tampilan ketika tidak ada booking -->
        <div class="text-center py-12">
            <div class="bg-white rounded-lg shadow-md p-8 max-w-md mx-auto">
                ...
                <p class="text-gray-500 mb-4">Saat ini belum ada lapangan yang dibooking. Jadilah yang pertama!</p>
                <a href="{{ route('booking.form') }}"
                    class="inline-block px-6 py-3 text-white font-medium rounded transition duration-300"
                    style="background-color: #A66E38;"
                    onmouseover="this.style.backgroundColor='#8B5A2B';"
                                ...
                                <th class="border px-4 py-3 bg-gray-50">
                                    <div class="flex flex-col items-center">
                                        <div class="flex items-center mb-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#A66E38] mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
