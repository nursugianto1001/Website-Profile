...
<div class="relative h-screen -mt-[70px] md:-mt-[80px]">
    ...
    <div class="absolute inset-0 z-20 flex items-center justify-left text-white text-left px-4 md:px-72 pt-16">
        <div class="max-w-xl" data-aos="fade-up" data-aos-duration="1000">
            <h1 class="text-5xl font-bold drop-shadow-lg leading-tight" style="font-family: 'Helvetica', sans-serif; font-weight: 700;">Waktunya Bergerak,</h1>
            <h1 class="text-5xl font-bold drop-shadow-lg leading-tight -mt-1" style="font-family: 'Helvetica', sans-serif; font-weight: 700;">Waktunya Karvin</h1>
            <h1 class="text-5xl font-bold drop-shadow-lg h-[4rem] overflow-hidden leading-tight -mt-1" style="font-family: 'Helvetica', sans-serif; font-weight: 700;">
                <span id="slide-text" class="block transition-all duration-500 ease-in-out">I'm Ready!</span>
            </h1>
            <p class="text-m drop-shadow-lg -mt-1" style="font-family: 'Helvetica', sans-serif;">Raih semangat juara dan maksimalkan performamu di lapangan badminton Karvin sekarang, mudah, cepat, dan tanpa antre!</p>
        </div>
    </div>
</div>
